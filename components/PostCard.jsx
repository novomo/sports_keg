  ...
  <div className="bg-black shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
      <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8 items-center">
        ...
        />
        <p className="inline align-middle text-white ml-2 font-medium text-lg font-semibold">{post.author.name}</p>
      </div>
      <div className="font-medium text-white font-semibold">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="text-center">
      <Link href={`/post/${post.slug}`}>
        <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-red-900 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Continue Reading</span>
      </Link>
    </div>
  </div>
  </div>
